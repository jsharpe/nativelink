...
fn enrich_request<T>(
    ...
    if !forward_headers.is_empty() {
        if let Some(client_headers) = Context::current().get::<ClientHeaders>() {
...
impl GrpcStore {
    ...
    pub async fn find_missing_blobs(
        ...
        self.perform_request(request, |request| async move {
            ...
            ContentAddressableStorageClient::new(channel)
                .find_missing_blobs(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    pub async fn batch_update_blobs(
        ...
        self.perform_request(request, |request| async move {
            ...
            ContentAddressableStorageClient::new(channel)
                .batch_update_blobs(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    pub async fn batch_read_blobs(
        ...
        self.perform_request(request, |request| async move {
            ...
            ContentAddressableStorageClient::new(channel)
                .batch_read_blobs(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    pub async fn get_tree(
        ...
        self.perform_request(request, |request| async move {
            let channel = self
                ...
                .err_tip(|| "in get_tree")?;
            ContentAddressableStorageClient::new(channel)
                .get_tree(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    async fn read_internal(
        ...
        let mut response = ByteStreamClient::new(channel)
            .read(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
            .await
                            ...
                            async move {
                                let res = ByteStreamClient::new(channel)
                                    .write(enrich_request(
                                        Request::new(WriteStateWrapper::new(
                                            local_state_for_rpc,
                                        )),
                                        &self.headers,
    ...
    pub async fn query_write_status(
        ...
        self.perform_request(request, |request| async move {
            ...
            ByteStreamClient::new(channel)
                .query_write_status(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    pub async fn get_action_result(
        ...
        self.perform_request(request, |request| async move {
            ...
            ActionCacheClient::new(channel)
                .get_action_result(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
    ...
    pub async fn update_action_result(
        ...
        self.perform_request(request, |request| async move {
            ...
            ActionCacheClient::new(channel)
                .update_action_result(enrich_request(Request::new(request), &self.headers, &self.forward_headers))
                .await
